...
<!-- Title --><div id="content-title"><?php $ta['status']=='NOTFOUND' ? '无此记录' : $ta['result']->title ?></div>
<?php 
if($ta['status']=='NOTFOUND'){
	return;
}
?>
...
<section id="single">
    ...
    <!-- END POST CONTENT -->
    <div id="authorinfo"><img id="author-avatar" src="images/commenter.png" alt="Avatar"/>
...
<form id="commentform" method="post" action="?">
    <div id="commentformleft">
        ...
        <span class="button-met light"><input id="comsubmit" type="submit" name="comsubmit" value="Post Comment" /></span>
