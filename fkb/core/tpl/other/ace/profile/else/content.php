...
if(!$destuser){
	print "<br><br><br><br><br><br><br><center style='font-size:50px;font-family:微软雅黑;'>该用户不存在或被关进小黑屋啦</center>";
	return;
}
// OrekiUtil::var_dump_array($destuser);
// return;
?>
				...
				<div class="pull-right">
					...
					<div class="btn-toolbar inline middle no-margin">
						<div data-toggle="buttons" class="btn-group no-margin">
							...
							<label class="btn btn-sm btn-inverse hide">
								...
								<div class="col-xs-12 col-sm-3 center">
									...
									<div class="profile-contact-info">
										<div class="profile-contact-links align-left">
											<a id="addAsContacts" shell="addAsContacts" params="<?php print $destuser->id ?>" class="btn btn-link ai-ajax" style="cursor: pointer;">
											...
											<a class="btn btn-link ai-ajax" shell="addUserFollow" params="<?php print $destuser->id?>" style="cursor: pointer;">
...
?>								
									<li id="<?php print 'collect_'.$collect['id']?>">
										...
										<div class="tools tools-bottom">
											...
											<a href="javascript:;" id="delMyCollect" shell="delMyCollect" params="<?php print $collect['id']?>" class="hide ai-ajax">
