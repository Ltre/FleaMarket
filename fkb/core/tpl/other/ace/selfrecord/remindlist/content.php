					...
					<div class="tabbable">
						<ul id="inbox-tabs" class="inbox-tabs nav nav-tabs padding-16 tab-size-bigger tab-space-1">
							<li class="li-new-mail pull-right hide">
								<a data-toggle="tab" href="#write" data-target="write" class="btn-new-mail hide">
									<span class="btn bt1n-small btn-purple no-border hide">
										<i class=" icon-envelope bigger-130 hide"></i>
										<span class="bigger-110 hide">发送私信</span>
									</span>
								</a>
							</li><!-- ./li-new-mail -->
							...
							<li <?php print 0==$opt?'class="active"':'' ?>>
								<a data-toggle="tab" onclick="javascript:location.href='<?php print "?x=listSelfRemind|0|$num|0"?>';" style="cursor: pointer;" data-target="inbox">
							...
							<li <?php print 1==$opt?'class="active"':'' ?>>
								<a data-toggle="tab" onclick="javascript:location.href='<?php print "?x=listSelfRemind|1|$num|0"?>';" style="cursor: pointer;" data-target="sent">
									<i class="orange icon-location-arrow bigger-130 "></i>
									<span class="bigger-110">已读</span>
								</a>
							</li>

							<li class="hide">
								<a data-toggle="tab" onclick="javascript:location.href='<?php print "?x=listSelfRemind|2|$num|0"?>';" style="cursor: pointer;" data-target="draft">
									<i class="green icon-pencil bigger-130"></i>
									<span class="bigger-110">已发送</span><!-- 已发送 -->
								</a>
							</li>
										...
										<div>
											...
											<div class="messagebar-item-right">
												<div class="inline position-relative">
													...
													<button type="button" onclick="javascript:location.href='<?php print "?x=listSelfRemind|$opt|$num|0"?>';" class="btn btn-sm btn-success">刷新</button>
												</div>
											</div>
...
?>											
											...
											<div class="message-item message-unread" me="<?php print$_SESSION['user']->id?>" opt="<?php print$self['opt']?>">
												...
												<a class="msgtype" msgtype="<?php print$letter['msgtype']?>" title="提醒类型" href="javascript:;" style="width:200px;" >
													<font color="green"><?php print $letter['msgtypevalue']?></font>提醒：
												</a>
												...
												<span class="summary">
													...
													<span class="text" shell="getRemindDetail" params="<?php print $letter['id']?>">
...
?>
									...
									<div class="message-footer clearfix">
										<div class="pull-left"> <?php print $self['total'] ?> 条提醒 </div>
										...
										<div class="pull-right">
											...
											<ul class="pagination middle">
												<li>
													<a href="<?php print "?x=listSelfRemind|".$self['opt'].'|'.$self['num'].'|0' ?>">
												...
												<li>
													...
													?>
													<a href="<?php print "?x=listSelfRemind|".$self['opt'].'|'.$self['num'].'|'.($prevpage-1)*$self['num'] ?>">
												...
												<li>
													<span>
														<?php $puprefix = '?x=listSelfRemind|'.$self['opt'].'|'.$self['num'].'|'?>
												...
												<li>
													...
													?>
													<a href="<?php print "?x=listSelfRemind|".$self['opt'].'|'.$self['num'].'|'.($nextpage-1)*$self['num'] ?>">
														<i class="icon-caret-right bigger-140 middle"></i>
													</a>
												</li>

												<li>
													<a href="<?php print "?x=listSelfRemind|".$self['opt'].'|'.$self['num'].'|'.($pagesum-1)*$self['num'] ?>">
