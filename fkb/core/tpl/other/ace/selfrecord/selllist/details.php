...
<div class="page-content">
	...
	<h1><?php print($details->title)?>
		...
		<button shell="pageToCreateFleaInfo" params="editsell|<?php print($details->titlecode)?>" class="btn btn-inverse pull-right ai-skip">编辑</button>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			?>
			<img src="<?php print FleaoptUtil::getFleaImgUrl($details->id, 'sell'); //print($img_file)?>" style="border: 2px groove;" width="399px" />
		</div>
