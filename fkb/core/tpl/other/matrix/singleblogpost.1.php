...
<!--[if IE 9]>
  <style type="text/css">
  @import url("res/Matrix/style-ie9.css");
  </style>
<![endif]-->
...
<section id="single">
    ...
    <!-- END POST CONTENT -->
    <div id="authorinfo"><img id="author-avatar" src="res/Matrix/images/commenter.png" alt="Avatar"/>
...
<div class="tile-sidebar">
    <div class="meta1">
    <img src="res/Matrix/images/sidebar-comm.png" alt="Comments" />
...
<div class="tile-sidebar" style="background:#3b5998">
    <div class="meta2">
    <img src="res/Matrix/images/sidebar-fb.png" alt="Facebook" />
    <div class="count"></div>
    <div id="fb-root"></div>
...
<div class="tile-sidebar" style="background:#3cf">
    <div class="meta3">
    <img src="res/Matrix/images/sidebar-twtr.png" alt="Twitter" />
    <div class="count"></div>
